export default function Footer() {
    return (
        <footer className="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-900">
            ...
            <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://colltrie.com/" className="hover:underline">CollectiveTrie™</a>. All Rights Reserved.
            </span>
        </footer>
    )
}